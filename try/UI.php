...
class UI
{
	...
	*/
	 ...
	 */
	public static function createElement(string $element, array $props = [], $children = [], string $type = "normal")
	{
	...
	public static function createStyles(array $styles, array $props)
	{
		...
		return self::createElement("style", $props, $parsed_styles);
	}
	 ...
	 * 
	 * eg: `Column` parses to HTML <div> and CSS flex
	 * 
	...
	public static function make(string $name, callable $handler)
	{
		if (is_callable($handler)) {
			self::$customElements[$name] = call_user_func($handler, $name);
		}
	}
	...
	{
		$element = self::$customElements[$name];
		$compile_to = "";
		$attributes = "";
		$type = strtolower($type);
		$subs = "";
		...
		if ($type == self::SELF_CLOSING) {
			return self::selfClosing($compile_to, $attributes, $id);
		}
	...
	public static function _script($src, array $props = [])
	{
		...
		return self::createElement("script", $props, $src);
	}
	...
	*/
	...
	{
		return self::createElement("!Doctype html", [], [], self::SINGLE_TAG) . self::createElement("html", $props, $children);
	}
	...
	{
		return self::createElement("head", $props, $children);
	}
	...
	{
		return self::createElement("body", $props, $children);
	}
	...
	{
		return self::createElement("header", $props, $children);
	}
	...
	{
		return self::createElement("nav", $props, $children);
	}
	...
	{
		return self::createElement("footer", $props, $children);
	}
	...
	{
		return self::createElement("aside", $props, $children);
	}
	...
	{
		return self::createElement("br", $props, [], self::SINGLE_TAG);
	}
	...
	{
		return self::createElement("hr", $props, [], self::SINGLE_TAG);
	}
	...
	{
		return self::createElement("a", $props, $children);
	}
	...
	{
		return self::createElement("div", $props, $children);
	}
	...
	{
		return self::createElement("span", $props, $children);
	}
	...
	{
		return self::createElement("section", $props, $children);
	}
	...
	{
		return self::createElement("hgroup", $props, $children);
	}
	...
	{
		return self::createElement("h1", $props, $children);
	}
	...
	{
		return self::createElement("h2", $props, $children);
	}
	...
	{
		return self::createElement("h3", $props, $children);
	}
	...
	{
		return self::createElement("h4", $props, $children);
	}
	...
	{
		return self::createElement("h5", $props, $children);
	}
	...
	{
		return self::createElement("h6", $props, $children);
	}
	...
	{
		return self::createElement("blockquote", $props, $children);
	}
	...
	{
		return self::createElement("p", $props, $children);
	}
	...
	{
		return self::createElement("article", $props, $children);
	}
	...
	{
		return self::createElement("details", $props, $children);
	}
	...
	{
		return self::createElement("summary", $props, $children);
	}
	...
	*/
	...
	public static function link(string $href, string $rel = "stylesheet", array $props = [])
	{
		$props["href"] = $href;
		$props["rel"] = $rel;
		return self::createElement("link", $props, [], self::SINGLE_TAG);
	}
	...
	{
		$props["href"] = $href;
		return self::createElement("base", $props, [], self::SINGLE_TAG);
	}
	...
	{
		return self::createElement("title", $props, [$title]);
	}
	...
	public static function meta(string $name, string $content, array $props = [])
	{
		...
		return self::createElement("meta", $props, [], self::SINGLE_TAG);
	}
	...
	*/
	...
	{
		return self::createElement("tt", $props, $children);
	}
	...
	{
		$props["title"] = $title;
		return self::createElement("abbr", $props, $children);
	}
	...
	{
		return self::createElement("address", $props, $children);
	}
	...
	{
		return self::createElement("bdi", $props, $children);
	}
	...
	{
		return self::createElement("bdo", $props, $children);
	}
	...
	{
		return self::createElement("b", $props, $children);
	}
	...
	{
		return self::createElement("i", $props, $children);
	}
	...
	{
		return self::createElement("u", $props, $children);
	}
	...
	{
		return self::createElement("small", $props, $children);
	}
	...
	{
		return self::createElement("big", $props, $children);
	}
	...
	{
		return self::createElement("sub", $props, $children);
	}
	...
	{
		return self::createElement("sup", $props, $children);
	}
	...
	*/
	...
	{
		return self::createElement("figure", $props, $children);
	}
	...
	{
		$props["src"] = $image;
		return self::createElement("img", $props, [], self::SINGLE_TAG);
	}
	...
	*/
	...
	public static function form(string $method, string $action, array $fields, array $props = [])
	{
		...
		return self::createElement("form", $props, $fields);
	}
	...
	public static function label(string $label, string $id = null, array $props = [])
	{
		...
		$props["id"] = $id;
		$props["for"] = $id;
		return self::createElement("label", $props, is_array($label) ? $label : [$label]);
	}
	...
	public static function input(string $type, string $name, array $props = [])
	{
		...
		$output .= self::createElement("input", $props, []);
		return $output;
	}
	...
	public static function textarea(string $name, array $props = [], string $children = "")
	{
		...
		$output .= self::createElement("textarea", $props, [$children]);
		return $output;
	}
	...
	{
		$props["id"] = $id;
		return self::createElement("datalist", $props, self::loop($list, function ($value) {
	...
	{
		return self::createElement("select", $props, self::loop($list, function ($text, $value) {
	...
	{
		$props["value"] = $value;
		return self::createElement("option", $props, $text);
	}
	 ...
	 */
	public static function button($text, array $props = [])
	{
		return self::createElement("button", $props, is_string($text) ? [$text] : $text);
	}
	...
	*/
	 ...
	 * @param array $props Element props
	 */
	public static function Uppercase($children, array $props = [])
	{
	 ...
	 * @param array $props Element props
	 */
	public static function Container($children, array $props = [])
	{
	 ...
	 * @param array $props Element props
	 */
	public static function Row(array $children, array $props = [])
	{
		if (!isset($props["style"])) {
			$props["style"] = "";
		}
	 ...
	 * @param array $props Element props
	 */
	public static function Column(array $children, array $props = [])
	{
		if (!isset($props["style"])) {
			$props["style"] = "";
		}
	 ...
	 */
	public static function CustomDatalist(string $type, string $name, string $id, array $list, array $props = [])
	{
	 ...
	 */
	public static function Preloader($children, array $props = [])
	{
